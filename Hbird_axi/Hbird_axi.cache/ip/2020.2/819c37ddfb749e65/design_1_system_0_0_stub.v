...
// Date        : Tue Jun 21 16:02:53 2022
// Host        : ubuntu running 64-bit Ubuntu 18.04.6 LTS
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_system_0_0_stub.v
// Design      : design_1_system_0_0
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(CLK200MHZ_P, CLK200MHZ_N, ck_rst, led_0, led_1, 
  led_2, led_3, slwclk, clk16M, sw_0, sw_1, sw_2, sw_3, btn_1, btn_2, btn_3, uart_rxd_out, uart_txd_in, ja_0, 
  ja_1, jd_0, jd_1, jd_2, jd_4, jd_5, jd_6, expl_axi_icb_cmd_valid, expl_axi_icb_cmd_ready, 
  expl_axi_icb_cmd_addr, expl_axi_icb_cmd_read, expl_axi_icb_cmd_wdata, 
  expl_axi_icb_cmd_wmask, expl_axi_icb_rsp_valid, expl_axi_icb_rsp_ready, 
  expl_axi_icb_rsp_rdata, expl_axi_icb_rsp_err, expl_axi_arvalid, expl_axi_arready, 
...
/* synthesis syn_black_box black_box_pad_pin="CLK200MHZ_P,CLK200MHZ_N,ck_rst,led_0,led_1,led_2,led_3,slwclk,clk16M,sw_0,sw_1,sw_2,sw_3,btn_1,btn_2,btn_3,uart_rxd_out,uart_txd_in,ja_0,ja_1,jd_0,jd_1,jd_2,jd_4,jd_5,jd_6,expl_axi_icb_cmd_valid,expl_axi_icb_cmd_ready,expl_axi_icb_cmd_addr[31:0],expl_axi_icb_cmd_read,expl_axi_icb_cmd_wdata[31:0],expl_axi_icb_cmd_wmask[3:0],expl_axi_icb_rsp_valid,expl_axi_icb_rsp_ready,expl_axi_icb_rsp_rdata[31:0],expl_axi_icb_rsp_err,expl_axi_arvalid,expl_axi_arready,expl_axi_araddr[31:0],expl_axi_arcache[3:0],expl_axi_arprot[2:0],expl_axi_arlock[1:0],expl_axi_arburst[1:0],expl_axi_arlen[3:0],expl_axi_arsize[2:0],expl_axi_awvalid,expl_axi_awready,expl_axi_awaddr[31:0],expl_axi_awcache[3:0],expl_axi_awprot[2:0],expl_axi_awlock[1:0],expl_axi_awburst[1:0],expl_axi_awlen[3:0],expl_axi_awsize[2:0],expl_axi_rvalid,expl_axi_rready,expl_axi_rdata[31:0],expl_axi_rresp[1:0],expl_axi_rlast,expl_axi_wvalid,expl_axi_wready,expl_axi_wdata[31:0],expl_axi_wstrb[3:0],expl_axi_wlast,expl_axi_bvalid,expl_axi_bready,expl_axi_bresp[1:0]" */;
  ...
  inout jd_5;
  input jd_6;
  input expl_axi_icb_cmd_valid;
  output expl_axi_icb_cmd_ready;
  input [31:0]expl_axi_icb_cmd_addr;
  input expl_axi_icb_cmd_read;
  input [31:0]expl_axi_icb_cmd_wdata;
  input [3:0]expl_axi_icb_cmd_wmask;
  output expl_axi_icb_rsp_valid;
  input expl_axi_icb_rsp_ready;
  output [31:0]expl_axi_icb_rsp_rdata;
  output expl_axi_icb_rsp_err;
