...
#set_property -dict { PACKAGE_PIN AE18    IOSTANDARD LVCMOS33 } [get_ports { led_3 }]; #IOA PIN29   in order to let L7 to be able to test AXI
...
###test signal 
#set_property -dict { PACKAGE_PIN AF18   IOSTANDARD LVCMOS33 } [get_ports { slwclk }];
#set_property -dict { PACKAGE_PIN AF20   IOSTANDARD LVCMOS33 } [get_ports { clk16M }];
