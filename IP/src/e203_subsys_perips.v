...
//XIAOLEI*******AXI Slave********************//
  wire                     slv_expl_axi_icb_cmd_valid;
  wire                     slv_expl_axi_icb_cmd_ready;
  wire [32-1:0]            slv_expl_axi_icb_cmd_addr; 
  wire                     slv_expl_axi_icb_cmd_read; 
  wire [32-1:0]            slv_expl_axi_icb_cmd_wdata;
  wire [4 -1:0]            slv_expl_axi_icb_cmd_wmask;
  
  wire                     slv_expl_axi_icb_rsp_valid;
  wire                     slv_expl_axi_icb_rsp_ready;
  wire [32-1:0]            slv_expl_axi_icb_rsp_rdata;
  wire                     slv_expl_axi_icb_rsp_err;
//XIAOLEI*********AXI Slave**********************//
  ...
  //  * Example-AXI      : 0x1004 0000 -- 0x1004 FFFF    64K
  //  * Example-slv_AXI  : 0x1005 0000 -- 0x1005 FFFF    not applicable
  //  * Example-APB      : 0x1004 1000 -- 0x1004 1FFF    delete
  ...
  .O13_BASE_REGION_LSB (16)
  
//      // * Here is an example AXI slave Peripheral
//  .O14_BASE_ADDR       (32'h1005_0000),       
//  .O14_BASE_REGION_LSB (16)
...
//  .O15_BASE_REGION_LSB (3)// I2C only have 3 bits address width
  ...
  //  * SysPer    
   ...
   //  * Example AXI    
    ...
    .o13_icb_cmd_ready  (expl_axi_icb_cmd_valid),
    .o13_icb_cmd_addr   (expl_axi_icb_cmd_valid ),
    .o13_icb_cmd_read   (expl_axi_icb_cmd_valid ),
    ...
    .o14_icb_cmd_valid  (slv_expl_axi_icb_cmd_valid),
    .o14_icb_cmd_ready  (slv_expl_axi_icb_cmd_valid),
    .o14_icb_cmd_addr   (slv_expl_axi_icb_cmd_valid ),
    .o14_icb_cmd_read   (slv_expl_axi_icb_cmd_valid ),
    .o14_icb_cmd_wdata  (slv_expl_axi_icb_cmd_wdata),
    .o14_icb_cmd_wmask  (slv_expl_axi_icb_cmd_wmask),
    .o14_icb_cmd_lock   (),
    .o14_icb_cmd_excl   (),
    .o14_icb_cmd_size   (),
    .o14_icb_cmd_burst  (),
    ...
    .o14_icb_rsp_valid  (slv_expl_axi_icb_rsp_valid),
    .o14_icb_rsp_ready  (slv_expl_axi_icb_rsp_ready),
    .o14_icb_rsp_err    (slv_expl_axi_icb_rsp_err),
    .o14_icb_rsp_excl_ok(1'b0  ),
    .o14_icb_rsp_rdata  (slv_expl_axi_icb_rsp_rdata),
...
sirv_expl_axi_slv # (
  ...
  .DW   (`E203_XLEN) 
    ...
    .axi_arvalid   (slv_expl_axi_arvalid),
    .axi_arready   (slv_expl_axi_arready),
    .axi_araddr    (slv_expl_axi_araddr ),
    .axi_arcache   (slv_expl_axi_arcache),
    .axi_arprot    (slv_expl_axi_arprot ),
    .axi_arlock    (slv_expl_axi_arlock ),
    .axi_arburst   (slv_expl_axi_arburst),
    .axi_arlen     (slv_expl_axi_arlen  ),
    .axi_arsize    (slv_expl_axi_arsize ),
     
    .axi_awvalid   (slv_expl_axi_awvalid),
    .axi_awready   (slv_expl_axi_awready),
    .axi_awaddr    (slv_expl_axi_awaddr ),
    .axi_awcache   (slv_expl_axi_awcache),
    .axi_awprot    (slv_expl_axi_awprot ),
    .axi_awlock    (slv_expl_axi_awlock ),
    .axi_awburst   (slv_expl_axi_awburst),
    .axi_awlen     (slv_expl_axi_awlen  ),
    .axi_awsize    (slv_expl_axi_awsize ),
    
    .axi_rvalid    (slv_expl_axi_rvalid ),
    .axi_rready    (slv_expl_axi_rready ),
    .axi_rdata     (slv_expl_axi_rdata  ),
    .axi_rresp     (slv_expl_axi_rresp  ),
    .axi_rlast     (slv_expl_axi_rlast  ),
   
    .axi_wvalid    (slv_expl_axi_wvalid ),
    .axi_wready    (slv_expl_axi_wready ),
    .axi_wdata     (slv_expl_axi_wdata  ),
    .axi_wstrb     (slv_expl_axi_wstrb  ),
    .axi_wlast     (slv_expl_axi_wlast  ),
  
    .axi_bvalid    (slv_expl_axi_bvalid ),
    .axi_bready    (slv_expl_axi_bready ),
    .axi_bresp     (slv_expl_axi_bresp  ),
